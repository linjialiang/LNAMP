...
```shell
$ apt install gcc g++ make cmake autotool autoconf automake tar bzip2 gzip
```
...
3. 安装 `autotool` `autoconf` `automake`
   ...
   ```shell
   # 有依赖
   $ apt install autotool autoconf automake
   ```
