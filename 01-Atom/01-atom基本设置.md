...
+===============================================================================
| @Last modified time: 2019-05-11 09:17:58
+===============================================================================
-->
...
| atom-ternjs 快捷键 | 功能             |
| ------------------ | ---------------- |
| `ctrl-k ctrl-r`    | 重构当前属性     |
| `ctrl-k ctrl-c`    | 当前属性列表     |
| `ctrl-k ctrl-d`    | 当前变量定义位置 |
| `ctrl-k ctrl-i`    | 对属性的描述     |
| `ctrl-k ctrl-[`    | 属性列表向上推进 |
| `ctrl-k ctrl-]`    | 属性列表向下推进 |
